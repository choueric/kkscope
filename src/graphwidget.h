 ...
 * This class is based on a QGraphicView widget, and displays two types of
 * Graphic items: GraphNode, which draws the name of a function inside a
 ...
 * instructions are used to create the appropriate graphic items.
