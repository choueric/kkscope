...
void SymbolCompletion::slotQueryFinished(uint /* nRecords */)
{
	...
	// user
	connect(m_pCCObject, 
		SIGNAL(filterInsertString(KTextEditor::CompletionItem*, QString*)),
		this, 
		SLOT(slotFilterInsert(KTextEditor::CompletionItem*, QString*)));
 ...
 */
void SymbolCompletion::slotFilterInsert(KTextEditor::CompletionItem* pEntry, 
